...
(function () {
  const DETAILS = {
    ...
    "ob-kec-check": "KEC nhận OR: check tồn kho, check có cần xả lẻ (split shipment) không, check yêu cầu VAS, rồi chuẩn bị/gửi file Outbound Request cho WH.",
    "ob-wh-plan": "WH nhận OR File (Request): check tồn thực tế, điền số tờ khai hải quan, xác định nguồn factory (VN/CN), phân bổ số lượng, xác nhận CO/NO-CO, rồi hoàn thiện OR file phản hồi lại KEC.",
    "ob-kec-confirm": "KEC review OR file WH trả về, gửi khách xác nhận CO. Nếu khách confirm: upload OR lên FOMS và trigger WH thực thi (FOMS OR lưu lại làm căn cứ).",
    "ob-customer-confirm": "Customer xác nhận CO (Certificate of Origin) cho lô hàng xuất — bước bắt buộc trước khi WH thực thi pick&pack.",
    "ob-execution": "WAREHOUSE EXECUTION (SLA): Pick → VAS (Value Added Services, nếu có) → Labeling (nếu có) → Pack → DO Preparation → Submit to Customs.",
    "ob-sla": "SLA Outbound theo 2 ngày: Day 1 = DO Declaration + Customs Submission (COT trước 14:00); Day 2 = Pickup Arrangement.",
    "ob-done": "Outbound Done — ETD +2 (tính từ khi OR được trigger, ước tính ngày xe rời kho).",
